...
class ConsignmentController extends Controller
{
    ...
    public function print(string $id)
    {
        ...
        $pdf = Pdf::loadView('pdf.consignment_receipt', compact('consignment'));
        $filename = 'Nota_Konsinyasi_'.str_replace(' ', '_', $consignment->supplier?->name ?? 'Supplier').'_'.date('YmdHis').'.pdf';
